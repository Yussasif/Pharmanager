...
const Checkout: React.FC = () => {
	...
	return (
		...
		<Header title={'Dispensary Counter'} subtitle={'view prescriptions'} linkTo={'/account/inbounds/prescriptions/prescriptions-manager'} />


		{display === 'checkout' && <div className='block-invoice'>
			<div className="counter-item-session">
				...
				<div className="counter-total">
					...
					{/* <Link to=""> */}
						...
						<div onClick={() => (setDisplay('successful'))} style={{
							width: '100%',
